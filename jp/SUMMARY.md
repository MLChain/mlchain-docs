...
* [モデル](guides/model-configuration/README.md)
  ...
  * [カスタマイズ可能モデルの追加](guides/model-configuration/customizable-model.md)
...
* [ワークフロー](guides/workflow/README.md)
  ...
  * [ノード説明](guides/workflow/node/README.md)
    ...
    * [変数代入](guides/workflow/node/variable\_assignment.md)
...
* [ユースケース](learn-more/use-cases/README.md)
  ...
  * [数分で業務データを持つ公式サイトのAIチャットボットを作成する方法](learn-more/use-cases/create-an-ai-chatbot-with-business-data-in-minutes.md)
  <!-- * [フルセットのオープンソースツールを使用したLLMアプリの実践：MlchainでBaichuanオープンソースモデル機能を呼び出す](learn-more/use-cases/practical-implementation-of-building-llm-applications-using-a-full-set-of-open-source-tools.md)
  * [MlchainをWeChatエコシステムに統合する方法](learn-more/use-cases/mlchain-on-wechat.md) -->
...
* [ユーザー契約](policies/yz/README.md)
  * [利用規約](https://mlchain.khulnasoft.com/terms)
  * [プライバシーポリシー](https://mlchain.khulnasoft.com/privacy)
