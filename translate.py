...
MLCHAIN_API_KEY = "example-key"

def translate_text(api_key=MLCHAIN_API_KEY, user_id="mark-doc", inputs={'input_text': 'Hello, how are you?', 'target_language': 'es'}):
    url = 'https://api.mlchain.khulnasoft.com/v1/workflows/run'
    headers = {
