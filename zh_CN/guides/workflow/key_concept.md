...
* 会话变量可在大部分节点内全局引用；
* 会话变量的写入需要使用[变量赋值](https://docs.mlchain.khulnasoft.com/v/zh-hans/guides/workflow/node/variable_assignment)节点；
* 会话变量为可读写变量；

关于如何将会话变量与变量赋值节点配合使用，请参考[变量赋值](https://docs.mlchain.khulnasoft.com/v/zh-hans/guides/workflow/node/variable_assignment)节点说明。
