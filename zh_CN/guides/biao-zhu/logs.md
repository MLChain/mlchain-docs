...
日志（Logs）功能用以观察与标记 Mlchain 应用的工作表现，Mlchain 为应用的全部交互过程记录了日志，无论你是通过 WebApp 或 API 调用的，如果你是 Prompt 工程师或 LLM 运营人员，它将为你提供可视化的 LLM 应用运营体验。
...
{% hint style="info" %}
这些标记将在 Mlchain 的后续版本中供模型微调使用，以提升模型的准确性与回复风格，当前预览版仅支持标记。
{% endhint %}
