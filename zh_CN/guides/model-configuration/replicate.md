...
Mlchain 支持接入 Replicate 上的 [Language models](https://replicate.com/collections/language-models) 和 [Embedding models](https://replicate.com/collections/embedding-models)。Language models 对应 Mlchain 的推理模型，Embedding models 对应 Mlchain 的 Embedding 模型。
...
4. 在 Mlchain 的 `设置 > 模型供应商 > Replicate` 中添加模型。
