...
Mlchain 支持以本地部署的方式接入 LocalAI 部署的大型语言模型推理和 embedding 能力。
...
5. LocalAI API 服务部署完毕，在 Mlchain 中使用接入模型
   ...
   - 服务器 URL：http://127.0.0.1:8080
     ...
     若 Mlchain 为 docker 部署，请填入 host 域名：`http://<your-LocalAI-endpoint-domain>:8080`，可填写局域网 IP 地址，如：`http://192.168.1.100:8080`
