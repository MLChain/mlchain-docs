...
Mlchain 支持接入 Ollama 部署的大型语言模型推理和 embedding 能力。
...
3. 在 Mlchain 中接入 Ollama
   ...
   - 基础 URL：`http://<your-ollama-endpoint-domain>:11434`
     ...
     若 Mlchain 为 docker 部署，建议填写局域网 IP 地址，如：`http://192.168.1.100:11434` 或 docker 宿主机 IP 地址，如：`http://172.17.0.1:11434`。
...
### ⚠️ 如果您使用Docker部署Mlchain和Ollama，您可能会遇到以下错误:
