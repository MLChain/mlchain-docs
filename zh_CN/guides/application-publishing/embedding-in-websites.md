...
Mlchain 支持将你的 AI 应用嵌入到业务网站中，你可以使用该能力在几分钟内制作具有业务数据的官网 AI 客服、业务知识问答等应用。点击 WebApp 卡片上的嵌入按钮，复制嵌入代码，粘贴到你网站的目标位置。

当你在网站中使用 Mlchain 聊天机器人气泡按钮时，你可以自定义按钮的样式、位置和其他设置。
...
## 自定义 Mlchain 聊天机器人气泡按钮

Mlchain 聊天机器人气泡按钮可以通过以下配置选项进行自定义：
...
window.mlchainChatbotConfig = {
    ...
    // 可选项，默认为 false
    isDev: false,
    // 可选项，当 isDev 为 true 时，默认为 '[https://dev.umlchain.app](https://dev.umlchain.app)'，否则默认为 '[https://umlchain.app](https://umlchain.app)'
