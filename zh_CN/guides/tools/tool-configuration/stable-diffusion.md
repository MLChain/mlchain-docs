# Stable Diffusion
StableDiffusion 是一种基于文本提示生成图像的工具，Mlchain 已经实现了访问 Stable Diffusion WebUI API 的接口，因此你可以直接在 Mlchain 中使用它。以下是在 Mlchain 中集成 Stable Diffusion 的步骤。
...
## 3. 在 Mlchain 中集成 Stable Diffusion
