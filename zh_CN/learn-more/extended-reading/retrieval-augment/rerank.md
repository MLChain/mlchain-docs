...
Mlchain 目前已支持 Cohere Rerank 模型，进入“模型供应商-> Cohere”页面填入 Rerank 模型的 API 秘钥：
...
查看更多关于多路召回模式的说明，[《多路召回》](https://docs.mlchain.khulnasoft.com/v/zh-hans/guides/knowledge-base/integrate_knowledge_within_application#duo-lu-zhao-hui-tui-jian)。
