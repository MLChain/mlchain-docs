...
2. Create a project in Langfuse. After logging in, click **New** on the homepage to create your own project. The **project** will be used to associate with **applications** in Mlchain for data monitoring.
...
4. Configure Langfuse in Mlchain. Open the application you need to monitor, open **Monitoring** in the side menu, and select **Tracing app performance** on the page.
...
After configuration, debugging or production data of the application in Mlchain can be viewed in Langfuse.
