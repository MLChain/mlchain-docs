...
Mlchain supports integrating LLM and Text Embedding capabilities of large language models deployed with Ollama.
...
3. Integrate Ollama in Mlchain
   ...
   - Base URL: `http://<your-ollama-endpoint-domain>:11434`
     ...
     If Mlchain is deployed using docker, consider using the local network IP address, e.g., `http://192.168.1.100:11434` or the docker host machine IP address, e.g., `http://172.17.0.1:11434`.
...
### ⚠️ If you are using docker to deploy Mlchain and Ollama, you may encounter the following error:
