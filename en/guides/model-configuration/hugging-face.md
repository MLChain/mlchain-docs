...
Mlchain supports Text-Generation and Embeddings. Below are the corresponding Hugging Face model types:
...
Mlchain supports accessing models on Hugging Face in two ways:
...
#### 2 Using access models in Mlchain
...
#### 3 Using access models in Mlchain

Select Inference Endpoints for Endpoint Type in `Settings > Model Provider > Hugging face > Model Type`. As shown below:

<figure><img src="/en/.gitbook/assets/guides/model-configuration/huggingface/use-model-in-mlchain.png" alt=""><figcaption></figcaption></figure>
