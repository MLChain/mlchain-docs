# Stable Diffusion
Stable Diffusion is a tool for generating images based on text prompts, Mlchain has implemented the interface to access the Stable Diffusion WebUI API, so you can use it directly in Mlchain. followings are steps to integrate Stable Diffusion in Mlchain.
...
## 3. Integrate Stable Diffusion in Mlchain
