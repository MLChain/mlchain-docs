---
description: Know more about Mlchain's billing plans to support expanding your usage.
---
...
Check out the [pricing page ](https://mlchain.khulnasoft.com/pricing)to learn more.
...
>
> **Message Requests:**The number of times the Mlchain API is called daily during application sessions (rather than LLM API resource usage). It includes all messages generated from your applications via API calls or during WebApp sessions. **Note:Daily quotas are refreshed at midnight Pacific Standard Time.**
>
> **RAG API Requests:**Refers to the number of API calls invoking only the knowledge base processing capabilities of Mlchain.
...
1.  What happens if my resource usage exceeds the Free plan before I upgrade to a paid plan?
    ...
    > During Mlchain's Beta stage, excess quotas were provided for free to seed users' workspaces. After Mlchain's billing system goes live, your existing data will not be lost, but your workspace can no longer process additional text vectorization storage. You will need to upgrade to a suitable plan to continue using Mlchain.
2.  What if neither the Professional nor Team plans meet my usage needs?

    > If you are a large enterprise requiring more advanced plans, please email us at [business@mlchain.khulnasoft.com](mailto:business@mlchain.khulnasoft.com).
3.  Under what circumstances do I need to pay when using the CE version?

    > When using the CE version, please follow our open source license terms. If you need commercial use, such as removing Mlchain's logo or requiring multiple workspaces, using Mlchain in a SaaS model, you will need to contact us at [business@mlchain.khulnasoft.com](mailto:business@mlchain.khulnasoft.com) for commercial licensing.
